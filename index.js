...
app.get("/admin", isAuthenticated, isAdmin, (req, res) => {
    ...
    const clientsSql = "SELECT COUNT(*) AS totalClients FROM clients";
    const produitsSql = "SELECT COUNT(*) AS totalProduits FROM produits";
    const facturesSql = "SELECT COUNT(*) AS totalFactures FROM factures";
    const revenueSql = "SELECT SUM(montant) AS totalRevenue FROM factures";
